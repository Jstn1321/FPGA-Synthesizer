...
#
# Script generated by Vivado on Thu Jun 11 16:55:06 -0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : waveforms.sh
...
#
# Usage        : waveforms.sh
#                waveforms.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                waveforms.sh [-rerun]
#                waveforms.sh [-reset_run]
#                waveforms.sh [-clean]
#                waveforms.sh [-reset_log]
#                waveforms.sh [-help]
#
...
# script info
echo -e "waveforms.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./waveforms.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_12 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot waveforms xil_defaultlib.waveforms xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim waveforms -key {Behavioral:sim_1:Functional:waveforms} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb waveforms.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./waveforms.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: waveforms.sh [-help]\n\
Usage: waveforms.sh [-step]\n\
Usage: waveforms.sh [-lib_map_path]\n\
Usage: waveforms.sh [-rerun]\n\
Usage: waveforms.sh [-reset_run]\n\
Usage: waveforms.sh [-clean]\n\
Usage: waveforms.sh [-reset_log]\n\
Usage: waveforms.sh [-keep_index]\n\
Usage: waveforms.sh [-noclean_files]\n\n\
