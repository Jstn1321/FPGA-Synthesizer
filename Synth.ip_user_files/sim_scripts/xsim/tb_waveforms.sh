...
#
# Script generated by Vivado on Thu Jun 11 17:21:45 -0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_waveforms.sh
...
#
# Usage        : tb_waveforms.sh
#                tb_waveforms.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_waveforms.sh [-rerun]
#                tb_waveforms.sh [-reset_run]
#                tb_waveforms.sh [-clean]
#                tb_waveforms.sh [-reset_log]
#                tb_waveforms.sh [-help]
#
...
# script info
echo -e "tb_waveforms.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_waveforms.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_12 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot tb_waveforms xil_defaultlib.tb_waveforms xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_waveforms -key {Behavioral:sim_1:Functional:tb_waveforms} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm blk_mem_gen_v8_4_12)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_waveforms.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_waveforms.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_waveforms.sh [-help]\n\
Usage: tb_waveforms.sh [-step]\n\
Usage: tb_waveforms.sh [-lib_map_path]\n\
Usage: tb_waveforms.sh [-rerun]\n\
Usage: tb_waveforms.sh [-reset_run]\n\
Usage: tb_waveforms.sh [-clean]\n\
Usage: tb_waveforms.sh [-reset_log]\n\
Usage: tb_waveforms.sh [-keep_index]\n\
Usage: tb_waveforms.sh [-noclean_files]\n\n\
