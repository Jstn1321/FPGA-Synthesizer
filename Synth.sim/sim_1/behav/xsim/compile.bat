...
REM
REM Generated by Vivado on Thu Jun 11 17:25:37 -0700 2026
...
echo "xvlog --incr --relax -prj waveforms_tb_vlog.prj"
call xvlog  --incr --relax -prj waveforms_tb_vlog.prj -log xvlog.log
